...
class RolloutBaseline(Baseline):
    ...
    def wrap_dataset(self, dataset):
        ...
        cost, _ = rollout(self.model, dataset, self.opts)
    ...
    def epoch_callback(self, model, epoch):
        ...
        candidate_cup_vals,_ = rollout(model, self.dataset, self.opts)
        candidate_vals = candidate_cup_vals.cpu().numpy()
